  ...
  <div class="container mx-auto px-4 py-16 flex">
    ...
    <div class="ml-20">
      ...
      <div class="flex">
        ...
        <span class="ml-2 text-gray-400 text-sm">{{ this.actor.birthday }}</span>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          <div v-for="movie in this.knownFor">
              <router-link :to="`/movie/${movie.id}`">
                <img :src="movieImage(movie)" alt="" class="mt-1 hover:opacity-75 transition ease-in-out duration-150">
                {{ movie.name }}
              </router-link>
          </div>
      </div>
...
export default {
    ...
    methods: {
        async fetchActor(actorId) {
            const response = await axios.get(`https://api.themoviedb.org/3/person/${actorId}?api_key=e307c533452fa386defdc60ee3c46409`)
            this.actor = response.data;
            this.knownFor = response.data
            console.log(this.actor);
        },
        async fetchCredits(actorId) {
            const response = await axios.get(`https://api.themoviedb.org/3/person/${actorId}/combined_credits?api_key=e307c533452fa386defdc60ee3c46409`)
